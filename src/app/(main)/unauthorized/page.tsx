  ...
  return (
    <div className="bg-background flex min-h-dvh flex-col items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-md text-center">
        ...
        <h1 className="mt-4 text-3xl font-bold tracking-tight sm:text-4xl">Access Denied</h1>
        <p className="text-muted-foreground mt-4">
          You do not have permission to access this section of the Customer Health Portal. Please contact your system
          administrator at admin@godeskless.com for assistance.
        </p>
        <div className="mt-6">
          <Link
            href="/dashboard"
