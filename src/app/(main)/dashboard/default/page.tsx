  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        const api1Response = await axios.get("https://stbbackend-dev.godeskless.com/api/get/traffic/", { headers });

        const api2Response = await axios.post(
          "https://stbbackend-dev.godeskless.com/api/get/daily-utilization/?category=whatsapp",
          { start_date: today, end_date: today },
          { headers },
        );

        const api3Response = await axios.post(
          "https://stbbackend-dev.godeskless.com/api/get/daily-utilization/?category=video",
          { start_date: today, end_date: today },
          { headers },
        );

        const api4Response = await axios.post(
          "https://stbbackend-dev.godeskless.com/api/get/daily-utilization/?category=sms",
          { start_date: today, end_date: today },
          { headers },
        );

        const api5Response = await axios.post(
          "https://stbbackend-dev.godeskless.com/api/get/daily-utilization/?category=disk_space",
          { start_date: today, end_date: today },
          { headers },
        );

        const api6Response = await axios.get(
          "https://stbbackend-dev.godeskless.com/api/get/tenants/analytics/?type=paid",
          { headers },
        );
        ...
        const api8Response = await axios.post(
          "https://stbbackend-dev.godeskless.com/api/get/recent-user-tenant-data/",
          { count: 5, fromDate: today, toDate: today, tenant_type: "paid" },
          { headers },
        );

        const api9Response = await axios.post(
          "https://stbbackend-dev.godeskless.com/api/get/recent-ticket-visit-tenant-data/",
          { count: 5, fromDate: today, toDate: today, tenant_type: "paid" },
          { headers },
        );

        const api10Response = await axios.post(
          "https://stbbackend-dev.godeskless.com/api/get/tenant-top-usage/",
          { count: 5, start_date: today, end_date: today, tenant_type: "paid" },
          { headers },
        );

        const api11Response = await axios.post(
          "https://stbbackend-dev.godeskless.com/api/get/least-recent-user-tenant-data/",
          { count: 5, fromDate: today, toDate: today, tenant_type: "paid" },
          { headers },
        );

        const api12Response = await axios.post(
          "https://stbbackend-dev.godeskless.com/api/get/least-ticket-visit-tenant-data/",
          { count: 5, fromDate: today, toDate: today, tenant_type: "paid" },
          { headers },
        );
